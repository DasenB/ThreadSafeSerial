...
//  ThreadSafeSerial
//
//  compare to answer from jtbandes:
//  https://stackoverflow.com/questions/39003986/usb-connection-delegate-on-swift
//
...
public class USBWatcher {
    ...
    public init(delegate: USBWatcherDelegate) {
        ...
        IONotificationPortSetDispatchQueue(notificationPort, DispatchQueue.init(label: "ThreadSafeSerial_usbObservationQueue"))
    }
